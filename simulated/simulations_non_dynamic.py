...
fig.tight_layout()
plt.savefig("/scratch/figures/mse_func_non-dyn.png", dpi=300)
...
fig.supylabel("Mean-squared error (MSE)", fontsize=12, fontweight="bold")
fig.tight_layout()
plt.savefig("/scratch/figures/mse_eff_non-dyn.png", dpi=300)
...
fig.suptitle("                      Non-dynamic system", fontweight="bold", fontsize=14)
fig.tight_layout()
plt.savefig("/scratch/figures/corr_func_non-dyn.png", dpi=300)
...
fig.suptitle("                              Non-dynamic system", fontweight="bold", fontsize=14)
fig.tight_layout()
plt.savefig("/scratch/figures/corr_eff_non-dyn.png", dpi=300)
