...
CACHE_FILE = ROOT / "cache" / "simulations_non_dynamic.pkl"
...
plot_bar_from_dict("indirect_connections", axes[1][1], mse_dict, "non-zero_1_0", undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_1$ ↔ Node $y_0$ \n (non-zero)")
plot_bar_from_dict("indirect_connections", axes[2][1], mse_dict, "zero_2_0", undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_2$ ↔ Node $y_0$ \n (zero)")
plot_bar_from_dict("indirect_connections", axes[3][1], mse_dict, "non-zero_2_1", undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_2$ ↔ Node $y_1$ \n (non-zero)")
...
fig.suptitle("Non-dynamic system", fontweight="bold", fontsize=14)
fig.tight_layout()
plt.savefig(FIGURES_DIR / "mse_func_non-dyn.png", dpi=300)
...
plot_bar_from_dict("indirect_connections", axes[1][1], mse_dict, 'non-zero_1_0', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_1$ → Node $y_0$ \n (non-zero)")
plot_bar_from_dict("indirect_connections", axes[2][1], mse_dict, 'zero_0_1', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_0$ → Node $y_1$ \n (zero)")
plot_bar_from_dict("indirect_connections", axes[3][1], mse_dict, 'zero_0_2', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_0$ → Node $y_2$ \n (zero)")
plot_bar_from_dict("indirect_connections", axes[4][1], mse_dict, 'zero_2_0', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_2$ → Node $y_0$ \n (zero)")
plot_bar_from_dict("indirect_connections", axes[5][1], mse_dict, 'zero_1_2', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_1$ → Node $y_2$ \n (zero)")
plot_bar_from_dict("indirect_connections", axes[6][1], mse_dict, 'non-zero_2_1', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_2$ → Node $y_1$ \n (non-zero)")
...
fig.supylabel("Mean-squared error (MSE)", fontsize=12, fontweight="bold")
fig.tight_layout()
plt.savefig(FIGURES_DIR / "mse_eff_non-dyn.png", dpi=300)
...
plot_bar_from_dict("common_input", axes[0], corr_coef_dict, 'non-zero_2_0', undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_2$ ↔ Node $y_0$ \n (non-zero)")
plot_bar_from_dict("common_input", axes[1], corr_coef_dict, 'non-zero_2_1', undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_2$ ↔ Node $y_1$ \n (non-zero)")
plot_bar_from_dict("indirect_connections", axes[2], corr_coef_dict, 'non-zero_1_0', undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_1$ ↔ Node $y_0$ \n (non-zero)")
plot_bar_from_dict("indirect_connections", axes[3], corr_coef_dict, 'non-zero_2_1', undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_2$ ↔ Node $y_1$ \n(non-zero)")
plot_bar_from_dict("volume_conduction", axes[4], corr_coef_dict, 'non-zero_2_0', undirected_methods, ["Coh", "ciPLV", "imCoh", "dwPLI"], "Node $y_2$ ↔ Node $y_0$ \n (non-zero)")
...
fig.suptitle("                      Non-dynamic system", fontweight="bold", fontsize=14)
fig.tight_layout()
plt.savefig(FIGURES_DIR / "corr_func_non-dyn.png", dpi=300)
...
plot_bar_from_dict("common_input", axes[0], corr_coef_dict, 'non-zero_2_0', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_2$ → Node $y_0$ \n (non-zero)")
plot_bar_from_dict("common_input", axes[1], corr_coef_dict, 'non-zero_2_1', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_2$ → Node $y_1$ \n (non-zero)")
plot_bar_from_dict("indirect_connections", axes[2], corr_coef_dict, 'non-zero_1_0', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_1$ → Node $y_0$ \n (non-zero)")
plot_bar_from_dict("indirect_connections", axes[3], corr_coef_dict, 'non-zero_2_1', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_2$ → Node $y_1$ \n(non-zero)")
plot_bar_from_dict("volume_conduction", axes[4], corr_coef_dict, 'non-zero_2_0', directed_methods, ["gPDC", "dDTF", "pSGP"], "Node $y_2$ → Node $y_0$ \n (non-zero)")
...
fig.suptitle("                              Non-dynamic system", fontweight="bold", fontsize=14)
fig.tight_layout()
plt.savefig(FIGURES_DIR / "corr_eff_non-dyn.png", dpi=300)
